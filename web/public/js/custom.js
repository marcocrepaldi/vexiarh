...
POTENZA.masonry = function () {
  ...
  if (!$masonry.exists()) { return; }
  loadScript(plugin_path + 'isotope/isotope.pkgd.min.js', function() {
    setTimeout(function() {
      var $itemElement = '.masonry-main .masonry-item',
...
*************************/
    POTENZA.pniceScroll = function () {
        ...
        if (!$scrollbar.exists() && !$scrollbarX.exists()) { return; }
        loadScript(plugin_path + 'nicescroll/jquery.nicescroll.js', function() {
          ...
          if ($scrollbarX.exists()) {
            $scrollbarX.niceScroll({
              scrollspeed: 150,
              mousescrollstep: 38,
              cursorwidth: 5,
              cursorborder: 0,
